...
export default async function CreateExpressionPage() {
  if (isDevAuthBypassEnabled()) {
    return (
      <AppFrame activePath="create" roleLabel="owner" userLabel={ownerGithubUsername}>
  ...
  return (
    <AppFrame activePath="create" roleLabel="owner" userLabel={session.user.githubLogin ?? undefined}>
      <ExpressionCaptureForm />
    </AppFrame>
  );
}
